...
$query = "SELECT * FROM tbl_registration WHERE mocktest_id = '" . $_GET['id'] . "' ORDER BY time ASC";
...
?>"><span
        ...
        class="fa fa-remove" title="Unregister"></button>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button style="font-size: 14px" type="submit" class="btn btn-primary btn-md" name="delete_participant">Yes</button>
